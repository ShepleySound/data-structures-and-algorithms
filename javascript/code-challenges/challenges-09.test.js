...
const hasChildrenValues = (arr, character) => {
  // Check to see if any of the characters match the character argument.
  return arr.some(element => {
    if (element.name.toLowerCase() === character.toLowerCase()) {
      // Create an array from the chosen character object.
      const values = Object.values(element);
      // Check to see if any of the properties are arrays. If so, they are (in this case) children.
